...
import featuresApi, { IFeatureGet } from '../../API/featuresApi';
...
const Feature: React.FunctionComponent<FeatureProps> = () => {
    ...
    const [features, setFeatures] = React.useState<IFeatureGet[]>();
    ...
    const handleChangeActive = (id: number) => {
        featuresApi.updateActive(id).then((res) => {
    ...
    const columns: ColumnsType<IFeatureGet> = [
        {
            title: 'MÃ',
            dataIndex: 'id',
            key: 'id',
        ...
        {
            title: 'TÊN TÍNH NĂNG',
            dataIndex: 'name_feature',
            key: 'name_feature',
        },
        {
            title: 'MÔ TẢ',
            dataIndex: 'description_feature',
            key: 'description_feature',
        },
        {
            title: 'HÌNH ẢNH',
            dataIndex: 'image_feature',
            key: 'image_feature',
            render: (image) => (
                <img
                    src={image}
    ...
    const handleChangeInput = (text: string) => {
        featuresApi.search(text).then((res) => {
            setFeatures(res);
        });
    };
            ...
            <div className="container">
                <Stack>
                    <Flex justifyContent="space-between">
                        <Heading fontSize="2.8rem">Tính năng</Heading>
                    </Flex>
                </Stack>
                <Stack
                    mt="2rem"
